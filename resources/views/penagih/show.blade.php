    ...
    <div class="p-6 flex flex-col gap-6">
        ...
        <div>
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <div>
                    <span class="text-[10px] text-slate-400 font-semibold block mb-0.5">Masa Laku Pajak</span>
                    <span class="text-xs font-bold text-indigo-600">{{ $pajak->masa_laku ?: '-' }}</span>
                </div>
                <div class="col-span-2">
                    <span class="text-[10px] text-slate-400 font-semibold block mb-0.5">Masa Laku STNK</span>
                    <span class="text-xs font-bold text-emerald-600">{{ $pajak->masa_stnk ?: '-' }}</span>
                </div>
            </div>
        </div>
...
<script>
    async function sendWhatsAppDetail(id, nopol, nama, nominal, pkb, opsen, jenis, merek, type, th, masa_laku, masa_stnk, nomor_hp, templateFormat) {
