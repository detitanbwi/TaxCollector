...
<head>
    ...
    <title>Login - Sistem Penagihan PKB Digital</title>
    <!-- Fonts -->
...
<body class="bg-slate-50 antialiased h-screen flex flex-col justify-center items-center p-4">
    ...
    <div class="w-full max-w-sm">
        ...
        <div class="text-center mb-8">
            <h1 class="text-2xl font-bold text-slate-900 tracking-tight">Penagihan PKB Digital</h1>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-slate-100 p-8">
            ...
            <form method="POST" action="{{ route('login') }}" class="space-y-5">
                ...
                <div>
                    ...
                    <input id="username"
                        class="block w-full rounded-xl border-slate-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-sm py-2.5"
