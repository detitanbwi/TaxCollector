...
class PenagihController extends Controller
{
    public function index(Request $request)
    {
        ...
        $totalPajak = PajakTagihan::count();
        $totalDitagih = PajakTagihan::where('is_ditagih', true)->count();
        $sisaTagihan = $totalPajak - $totalDitagih;

        return view('penagih.dashboard', compact('pajakList', 'whatsappFormat', 'totalPajak', 'totalDitagih', 'sisaTagihan'));
    }
